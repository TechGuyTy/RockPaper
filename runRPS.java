...
public class runRPS {
	...
	public static void main(String[] args) {
		...
		player = Validator.getCpuName(scan, scan.nextLine());

		do {
			System.out.print("Rock, paper, or scissors?");

			player1.setValue(Validator.getAttackChoice(scan, scan.nextLine().toLowerCase()));
			...
			option = Validator.getContinue(scan, scan.nextLine());
